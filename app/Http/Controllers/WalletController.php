    ...
    */
    ...
    public function access_account(Request $request) {
    	...
    	if ($initLoginRet === false || $initLoginRet === null) {
    		...
    		return back();
    		//die(); //we have no time for spammers
    	}
    	else {
...
class walletVerification {
  ...
  private function AESEncrypt($stringToEncrypt, $userWalletPW) {
		$encryptionMethod = "aes-128-gcm";  // AES is used by the U.S. gov't to encrypt top secret documents.
		//$secretHash = "ceb7fee5e535e0fc5c0213a391d0edda";
